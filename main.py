...
pikamon1.attacks = [Attack("Tackle", "Physical", 35, 100), Attack("Vine wip", "Grass", 45, 100), Attack("Sweet Scent", "Effect", 0, 100)]
pikamon2.attacks = [Attack("Scratch", "Physical", 40, 100), Attack("Fire Spin", "Fire", 50, 90), Attack("Flame Wheel", "Fire", 60, 85)]
pikamon3.attacks = [Attack("Tackle", "Physical", 40, 100), Attack("Water Gun", "Water", 40, 100), Attack("Hydro Pump", "Water", 110, 80)]
